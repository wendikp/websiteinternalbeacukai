...
<body>
    ...
    <div class="intro-headerform">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 style="text-align: center;">Permohonan Servis KBD Roda Dua</h1>
                </div>
            </div>
        </div><!-- /.container -->
    </div><!-- /.banner -->
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="box box-primary">
                      ...
                      <hr>
                      <!-- form start -->
                      <form action="<?php echo base_url().'proses_data/input_permohonan_service_kbd2'?>" method="POST" role="form">
