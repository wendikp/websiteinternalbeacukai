...
<body>
    ...
    <div class="intro-headerform">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 style="text-align: center;">Permohonan Cabut Izin Hunian</h1>
                </div>
            </div>
        </div><!-- /.container -->
    </div><!-- /.banner -->
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="box box-primary">
                      ...
                      <hr>
                      <!-- form start -->
                      <form action="<?php echo base_url().'proses_data/input_permohonan_cabut_hunian'?>" role="form" method="POST">
                          ...
                          <div class="form-group">
                              ...
                              <input name="tglmohon" type="text" class="form-control tanggal" id="tglmohon" placeholder="Tanggal Permohonan" style="width: 230px;" required="required">
                          </div>
