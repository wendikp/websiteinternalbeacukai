...
<body>
    ...
    <div class="intro-headerform">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 style="text-align: center;">Permohonan Perbaikan Inventaris Kategori BMN</h1>
                </div>
            </div>
        </div><!-- /.container -->
    </div><!-- /.banner -->
                      ...
                      <form role="form">
                          <div class="box-body">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="namalkp" placeholder="Nama Lengkap" style="width: 230px;" required="required">
                          </div>
                          <div class="form-group">
                              <label for="selectionField">Bidang/Bagian</label>
                              <select class="form-control" placeholder="Bidang/Bagian" name="selectionField" style="width: 230px;" required="required">
                                  <option value="umum" >Bagian Umum </option>
                                  <option value="fk" >Fasilitas Kepabeanan</option>
                                  <option value="ki" >Kepatuhan Internal</option>
                                  <option value="kc" >Kepabeanan dan Cukai</option>
                                  <option value="p2" >Penindakan dan Penyidikan</option>
                              </select>
                          </div>
                          <div class="form-group">
                              <label for="namalkp">Nomor Surat</label>
                              <input type="text" class="form-control" id="nosrt" placeholder="Nomor Surat" style="width: 230px;" required="required">
                          </div>
                          <div class="form-group">
                              <label for="namalkp">Barang Inventaris</label>
                              <input type="text" class="form-control" id="brginventaris" placeholder="Barang Inventaris" style="width: 230px;" required="required">
                          </div>
