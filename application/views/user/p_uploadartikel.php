    ...
    <body>
        ...
        <div class="intro-headerform">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 style="text-align: center;">Upload Artikel</h1>
                    </div>
                </div>
            </div><!-- /.container -->
        </div><!-- /.banner -->
        ...
        <a  name="about"></a>
        <div class="">
            <img src="<?php echo base_url().'assets/dist/img/grey background.jpg'?>" class="bg1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <h3>Silahkan isi data dibawah ini:</h3><hr>
                                <!-- form start -->
                                <form role="form" action="<?php echo base_url().'proses_data/input_artikel'?>" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="namalkp">Penulis</label>
                                            <input type="text" class="form-control" id="namalkp" name="penulis" placeholder="Nama Penulis" style="width: 230px;" required="required">
                                        </div>
                                        <div class="form-group">
                                            <label for="judul">Judul Artikel</label>
                                            <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul Artikel" style="width: 230px;" required="required">
                                        </div>
                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="box box-info">
                                                            <div class="box-body pad">
                                                                <textarea class="editor1" id="editor1" name="artikel" rows="10" cols="80"></textarea>
                                                            </div>
                                                        </div><!-- /.box -->
                                                    </div><!-- /.col-->
                                                </div><!-- ./row -->
