            ...
            <section class="content">
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <hr>
                      <!-- form start -->
                      <form action="<?php echo base_url().'proses_data/input_foto'?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                          <div class="box-body">
                              ...
                              <div class="form-group">
                                      ...
                                      <textarea class="form-control " name="deskripsi" rows="5" cols="80" style="width: 500px;"></textarea>
                              </div>
                          </div><!-- /.box-body -->
