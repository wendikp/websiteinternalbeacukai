      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active treeview">Daftar Admin</a></li>
            ...
            <div class="col-xs-6">
              <div class="box">
                <div class="box-header">
                  ...
                  <a style="width: 110px" class="btn btn-default btn-sm pull-right" href="<?php echo base_url().'proses_data/tambahAdmin'?>">
                    ...
                    <tbody>
                      ...
                      foreach ($data as $row) {
                        ...
                        <tr>
                          ...
                          <td width="80px">
                            <div class="btn-group">
                              <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/editAdmin/'.$row->nip?>"><i class="fa fa-edit"></i>
                              </a>
                              <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/deleteAdmin/'.$row->nip?>"><i class="fa fa-trash-o"></i>
                              </a>
                            </div>
                          </td>
                        </tr>
