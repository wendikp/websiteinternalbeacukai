              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="box">
                    ...
                    <div class="box-body">
                    <form action="<?php echo base_url().'proses_data/insert_user'?>" role="form" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nip" placeholder="NIP" style="width: 230px;" required="required">
                        </div>
                        <div class="form-group">
                          <label for="nopol">Nama Lengkap</label>
                          <input type="text" class="form-control" name="nama" placeholder="Nama Lengkap" style="width: 230px;" required="required">
                        </div>
                        <div class="form-group">
