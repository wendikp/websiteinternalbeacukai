          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().'proses_data/get_daftarAdmin' ?>"><i class="fa fa-dashboard"></i> Daftar Admin</a></li>
                <li class="active treeview">Tambah</a></li>
              </ol>
            </section>
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="box">
                    ...
                    <div class="box-body">
                    <form action="<?php echo base_url().'proses_data/insert_admin'?>" role="form" method="POST">
                        <div class="form-group">
                          <label for="nopol">Username</label>
                          <input type="text" class="form-control" name="user" placeholder="Username" style="width: 230px;" required="required">
                        </div>
                        <div class="form-group">
                          <label for="tanggal">Password</label>
                          <input type="text" class="form-control" name="pwd" placeholder="Password" style="width: 230px;" required="required">
                        </div>
                        <div class="form-group">
                          <label for="description">Status</label>
                          <select name="status" class="form-control" style="width: 230px;" required="required">
                             <option></option>
                             <option value="1">Admin Root</option>
