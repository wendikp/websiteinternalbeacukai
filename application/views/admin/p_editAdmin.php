              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <div class="box-body">
                    ...
                    foreach($data as $row){
                      ?>
                      <form name="edit" action="<?php echo base_url().'proses_data/updateDataAdmin/'.$row->nip?>" role="form" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                          <label for="exampleInputFile">Username</label>
                          <input type="text" class="form-control" name="user" style="width: 230px;" value="<?php echo $row->username?>">
                        </div>
                        <div class="form-group">
                          <label for="tanggal">Password</label>
                          <input type="text" class="form-control" name="pwd" style="width: 230px;" value="<?php echo $row->password?>">
                        </div>
                        <div class="form-group">
