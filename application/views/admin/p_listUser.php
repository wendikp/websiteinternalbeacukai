      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active treeview">Daftar User</a></li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <a style="width: 110px" class="btn btn-default btn-sm pull-right" href="<?php echo base_url().'proses_data/tambahUser'?>">
                        ...
                        <tr>
                          ...
                          <td width="80px">
                            ...
                            <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/editUser/'.$row->nip?>"><i class="fa fa-edit"></i>
                              ...
                              <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/deleteUser/'.$row->nip?>"><i class="fa fa-trash-o"></i>
                              </a>
                            </div>
                          </td>
                        </tr>
