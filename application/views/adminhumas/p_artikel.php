      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().'proses_data/get_daftarArtikel'?>">Daftar Artikel</a></li>
            <li class="active treeview">Artikel</li>
          </ol>
        </section>
              ...
              <div class="box">
                <div class="box-body">
                  ...
                  ?>
                    ...
                    <img src="<?php echo base_url().$row->path_foto?>" width=500px><br><br>
                    <p>Penulis : <?php echo $row->penulis?> | Tanggal : <?php echo $row->tanggal_upload?></p><br>
                    <p><?php echo $row->file_artikel?></p>
                  <?php
                  }
                  ?>
                </div><!-- /.box-body -->
