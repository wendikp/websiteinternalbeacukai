                  ...
                  <table id="example2" class="table table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      foreach ($data as $row) {
                        ?>
                        <tr>
                          <td><img src="<?php echo base_url().$row->path_foto?>" width=100px></td>
                          ...
                          <td width="80">
                            <div class="btn-group">
                            <a href="<?php echo base_url().'proses_data/viewPhoto/'.$row->id_foto?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-eye"></i></a>
                              <a href="<?php echo base_url().'proses_data/deletePhoto/'.$row->id_foto?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-trash-o"></i></a>
                            </div>
                          </td>
                        </tr>
                        <?php
