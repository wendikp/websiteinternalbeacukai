        ...
        <div class="wrapper">
          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                <li><a href="<?php echo base_url().'proses_data/get_daftarArtikel'?>"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().'proses_data/get_daftarVideo'?>">Daftar Video</a></li>
                ...
                <div class="col-xs-12">
                  <div class="box">
                    ...
                    <div class="box-body">
                      ...
                      ?>
                      <!-- Menampilkan Video -->
                      <video src="<?php echo base_url().$row->path_video?>" controls width="80%" ></video><br/><br/>
                      <table>
                        <tr>
                          <td width="60px">Filename</td>
                          <td width="10px;">:</td>
