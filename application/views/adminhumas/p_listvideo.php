                      ...
                      foreach ($data as $row) {
                        ...
                        <tr>
                          ...
                          if ($row->read_status  == "false") {
                            ?>
                            <td><?php echo $row->file_name?><sup><span class="label label-success">Baru</span></sup></td>
                            <?php
                          } else {
                            ?>
                          ...
                          <td width="90">
                            <div class="btn-group">
                              <a href="<?php echo base_url().'proses_data/viewVideo/'.$row->id_video?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-eye"></i></a>
                              <a href="<?php echo base_url().'proses_data/deleteVideo/'.$row->id_video?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-trash-o"></i></a>
                            </div>
                          </td>
                        </tr>
                        <?php
