            ...
            <div class="container topnav">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="<?php echo base_url().'p_rumahtangga'?>">Rumah Tangga</a>
                        </li>
                        <li class="dropdown">
                        <a id="dropdownResources" class="nav-link dropdown-toggle" aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" href="#"><i class="fa fa-angle-right pull-right"></i>Artikel</a>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="<?php echo base_url().'c_user/uploadartikel'?>">Upload Artikel</a>
                                <a class="dropdown-item" href="<?php echo base_url().'c_user/artikel'?>">Your Artikel</a>
                            </div>
                        </li>
                        <li class="dropdown">
                        <a id="dropdownResources" class="nav-link dropdown-toggle" aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" href="#"><i class="fa fa-angle-right pull-right"></i>Galeri</a>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="#">Upload Foto</a>
