      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().'proses_data/daftarKritikSaran'?>"> Daftar Kritik & Saran</a></li>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  <div class="mailbox-read-info">
                    ...
                    foreach ($data as $row) {
                      ?>
                      <h3><?php echo $row->perihal?></h3>
                      <h5>Dari: <?php echo $row->nama_lkp?> <span class="mailbox-read-time pull-right"><?php echo $row->tanggal?></span></h5>
                    </div><!-- /.mailbox-read-info -->
                    <div class="mailbox-read-message">
                      <?php echo $row->kritik_saran?>
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    <a href="<?php echo base_url().'proses_data/deleteKritikSaran/'.$row->id?>" class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i> Hapus</a>
                  </div>
                </div><!-- /.box-footer -->
              </div><!-- /. box -->
            </div><!-- /.col -->
