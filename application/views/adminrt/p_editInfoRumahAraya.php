      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().'proses_data/get_daftarRumahAraya'?>">  Daftar Perumahan Araya</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Edit Rumah Araya</h3>
                </div><!-- /.box-header -->
                <?php
                foreach ($data as $row) {
                  ?>
                  <div class="box-body">
                    <form name="edit" action="<?php echo base_url().'proses_data/updateInfoRumahAraya/'.$row->id_rumah?>" role="form" method="POST" enctype="multipart/form-data">
