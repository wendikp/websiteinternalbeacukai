      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().'proses_data/detailRiwayatServiceKBD2'?>"> Detail Servis</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Edit Riwayat Servis KBD Roda Dua : <b><?php foreach($data as $row){ echo $row->nopol; break;}?></b></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form action="<?php echo base_url().'proses_data/updateRiwayatKBD2/'.$row->id_service?>" role="form" method="POST">
