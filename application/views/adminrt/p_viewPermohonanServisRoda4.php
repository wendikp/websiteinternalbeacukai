          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().'proses_data/daftarPermohonanServisRoda4'?>"><i class="fa fa-dashboard"></i> Daftar Permohonan Servis</a></li>
                <li class="active">Permohonan Servis</li>
              </ol>
            </section>
                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Permohonan Servis KBD Roda Empat</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                      <div class="col-xs-6">
                        <table class="table">
                          ...
                          foreach ($data as $row) {
                            ...
                            <thead>
                              <tr>
                                <td colspan="3" style="text-align: center;"><b>INFORMASI PERMOHONAN SERVIS KBD RODA EMPAT</b></td>
                              </tr>
                            </thead>
                            <tbody>
                              <tr><td style="width: 150px;">Nomot Surat</td><td style="width: 30px;">:</td><td><?php echo $row->no_surat;?></td></tr>
                              <tr><td>Plat Nomor</td>        <td>:</td><td><?php echo $row->plat_nomor;?></td></tr>
                              <tr><td>NIP</td>               <td>:</td><td><?php echo $row->nip;?></td></tr>
                              <tr><td>Nama</td>              <td>:</td><td><?php echo $row->nama_lkp;?></td></tr>
                              <tr><td>Bidang/Bagian</td>     <td>:</td><td><?php echo $row->bagian;?></td></tr>
                              <tr><td>Jabatan</td>           <td>:</td><td><?php echo $row->jabatan;?></td></tr>
                              <tr><td>Pangkat/Golongan</td>  <td>:</td><td><?php echo $row->golongan;?></td></tr>
                              <tr><td>Tanggal Permohonan</td><td>:</td><td><?php echo $row->tgl_mohon;?></td></tr>
                        ...
                        <a href="<?php echo base_url().'surat_permohonan/printPermohonanServisKBD/'.$row->id_permohonan?>" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Cetak</a>
                      </div>
                    </div><!-- /.box-body -->
                  </div><!-- /.box -->
                </div><!-- /.col -->
