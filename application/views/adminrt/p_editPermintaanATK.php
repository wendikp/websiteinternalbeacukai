      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().'proses_data/get_daftarPermintaanATK'?>"><i class="fa fa-dashboard"></i> Daftar PermintaanATK</a></li>
            <li class="active">Edit Permintaan ATK</li>
          </ol>
        </section>
            ...
            <div class="col-md-8">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Permintaan ATK : <?php foreach ($data as $row) {echo $row->nosurat; break;} ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <?php
                  foreach ($data as $row) {
                    ...
                    <div class="col-md-6">
                      <table>
                        <tbody>
                          ...
                          <tr>
                            <td>NIP </td><td>: </td><td><?php echo $nip?></td>
                          </tr>
                          <tr>
                            <td>Jabatan </td><td>: </td><td><?php echo $jabatan?></td>
                          </tr>
                          <tr>
                            <td style="width: 120px;">Pangkat/Golongan </td><td style="width: 15px;">: </td><td><?php echo $golongan?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <form action="<?php echo base_url().'proses_data/updatePermintaanATK'?>" method="POST" role="form">
                        <table class="table table-bordered">
                          <tbody>
                            <tr>
                              <td>ID : </td><td>Barang : </td><td>Volume : </td><td> Satuan : </td><td>Hapus</td>
                            </tr>
                            ...
                            foreach ($data as $row) {
                              ?>
                              <tr>
                                <td style="width: 100px;"><input class="form-control" type="text" name="id[]" value="<?php echo $row->id_permintaan;?>" readonly></td>
                                <td><input class="form-control" type="text" name="barang[]" value="<?php echo $row->barang;?>" readonly></td>
                                <td><input class="form-control" type="text" name="volume[]" value="<?php echo $row->volume;?>"></td>
                                <td><input class="form-control" type="text" name="satuan[]" value="<?php echo $row->satuan; ?>"></td>
                                <td><a href="<?php echo base_url().'proses_data/deleteATK/'.$row->id_permintaan?>" class="btn btn-default btn-size"><i class="fa fa-trash-o"></i></a></td>
                              </tr>
                              <?php
                            }
                            ?>
