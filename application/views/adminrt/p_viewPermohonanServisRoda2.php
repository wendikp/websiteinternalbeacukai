          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().'proses_data/daftarPermohonanServisRoda2'?>"><i class="fa fa-dashboard"></i> Daftar Permohonan Servis</a></li>
                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Permohonan Servis KBD Roda Dua</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                      <div class="col-xs-6">
                        <table class="table">
                          ...
                          foreach ($data as $row) {
                            ...
                            <thead>
                              <tr>
                                <td colspan="3" style="text-align: center;"><b>INFORMASI PERMOHONAN SERVIS KBD RODA DUA</b></td>
                              </tr>
                            </thead>
                            <tbody>
