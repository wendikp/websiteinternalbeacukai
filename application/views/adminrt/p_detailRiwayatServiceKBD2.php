                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                      ...
                      <h3 class="box-title">Riwayat Servis KBD Roda Dua : 
                        <b><?php 
                          foreach ($data as $row) {
                            echo $row->nopol;
                            break;
                          ...
                          <tbody>
                            ...
                            foreach ($data as $row) {
                              ...
                              <tr>
                                ...
                                <td width="105px">
                                  <div class="btn-group">
                                    <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/editDetailServiceKBD2/'.$row->id_service?>"><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/tambahRiwayatServiceKBD2/'.$row->nopol?>"><i class="fa fa-plus"></i></a>
                                    <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/deleteDetailServiceKBD2/'.$row->id_service?>"><i class="fa fa-trash-o"></i></a>
                                  </div>
                                </td>
                              </tr>
                              <?php
