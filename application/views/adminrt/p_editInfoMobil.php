            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Edit Info KBD Roda Empat : 
                    <b>
                      <?php
                      foreach ($data as $row) {
                        echo $row->nopol;
                  ...
                  <div class="box-body">
                    ...
                    foreach($data as $row){
                      ?>
                      <form name="edit" action="<?php echo base_url().'proses_data/updateInfoMobil/'.$row->nopol?>" role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="merek" style="width: 230px;" value="<?php echo $row->merek?>">
                        </div>
                        <div class="form-group">
                          <label for="tanggal">PIC</label>
                          <input type="text" class="form-control" name="pic" style="width: 230px;" value="<?php echo $row->pic_kbd?>">
                        </div>
                        <div class="form-group">
                          <label for="tanggal">Nomor Kepemilikan</label>
                          <input type="text" class="form-control" name="nomorkep" style="width: 230px;" value="<?php echo $row->nomor_kep?>">
                        </div>
