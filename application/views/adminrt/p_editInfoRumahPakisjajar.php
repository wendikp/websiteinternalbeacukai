      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().'proses_data/get_daftarRumahPakisjajar'?>">  Daftar Perumahan Pakisjajar</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Edit Rumah Pakisjajar</h3>
                </div><!-- /.box-header -->
                <?php
                foreach ($data as $row) {
                  ?>
                  <div class="box-body">
                    <form name="edit" action="<?php echo base_url().'proses_data/updateInfoRumahPakisjajar/'.$row->id_rumah?>" role="form" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="tanggal">ID Listrik</label>
                        <input type="text" class="form-control" name="id_listrik" style="width: 230px;" value="<?php echo $row->id_listrik?>" required="required">
                      </div>
                      <div class="form-group">
                        <label for="tanggal">ID PDAM</label>
                        <input type="text" class="form-control" name="id_pdam" style="width: 230px;" value="<?php echo $row->id_pdam?>" required="required">
                      </div>
                      <div class="form-group">
                        <label for="tanggal">lokasi</label>
                        <input type="text" class="form-control" name="lokasi" style="width: 230px;" value="<?php echo $row->lokasi?>" required="required">
                      </div>
                      <div class="form-group">
                        <label for="tanggal">Alamat</label>
                        <input type="text" class="form-control" name="alamat" style="width: 230px;" value="<?php echo $row->alamat?>" required="required">
                      </div>
                      <div class="form-group">
                        <label for="tanggal">Penghuni</label>
                        <input type="text" class="form-control" name="penghuni" style="width: 230px;" value="<?php echo $row->penghuni?>">
                      </div>
                      <div class="form-group">
                        <label for="tanggal">Keterangan</label>
                        <textarea class="form-control " name="ket" rows="5" cols="80" style="width: 500px;"><?php echo $row->keterangan;?></textarea>
                      </div>
                      <div class="form-group">
