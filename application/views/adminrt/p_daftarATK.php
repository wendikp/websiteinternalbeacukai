            ...
            <div class="col-xs-6">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Daftar ATK</h3>
                  <a style="width: 110px" class="btn btn-default btn-sm pull-right" href="<?php echo base_url().'proses_data/tambahATK'?>">
                    ...
                    <tbody>
                      ...
                      foreach ( $data as $row) {
                        ...
                        <tr>
                          ...
                          <td width="140">
                            <div class="btn-group">
                              <a href="<?php echo base_url().'proses_data/editATK/'.$row->id_atk?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo base_url().'proses_data/deleteATKdiDaftar/'.$row->id_atk?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-trash-o"></i></a>
                            </div>
                          </td>
                        </tr>
                        <?php
