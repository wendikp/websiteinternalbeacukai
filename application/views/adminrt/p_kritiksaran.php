      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Daftar Kritik & Saran</li>
          </ol>
        </section>
                  ...
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active">
                      <a href="#"><i class="fa fa-inbox"></i> Inbox 
                        ...
                        if ($jumlah_kritik > 0) {
                          ?>
                          <span class="label label-primary pull-right"><?php echo $jumlah_kritik?></span>
                          <?php
                        }
                        ?>
                      </a>
                        ...
                        foreach ($data as $row) {
                          ...
                          <tr>
                            <td class="mailbox-name">
                              <a href="<?php echo base_url().'proses_data/readMail/'.$row->id?>"><?php echo $row->nama_lkp?>
                                <?php
                                if ($row->read_status == "false") {
                                  ?>
                                  <sup><span class="label label-success">Baru</span></sup>
                                  <?php
                                }
                                ?>
                              </a>
                            </td>
                            <td class="mailbox-subject"><b><?php echo $row->perihal?></b></td>
                            <td class="mailbox-date"><?php echo $row->tanggal?></td>
                            <td>
                              <a href="<?php echo base_url().'proses_data/deleteKritikSaran/'.$row->id?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-trash-o"></i></a>
                            </td>
                          </tr>
                          <?php
                        }
