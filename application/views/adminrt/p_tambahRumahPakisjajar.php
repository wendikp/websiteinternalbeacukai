            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Tambah Rumah Pakisjajar</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form name="edit" action="<?php echo base_url().'proses_data/insert_rumahPakisjajar'?>" role="form" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="tanggal">ID Listrik</label>
                      <input type="text" class="form-control" name="id_listrik" style="width: 230px;" required="required">
                    </div>
                    <div class="form-group">
                      <label for="tanggal">ID PDAM</label>
                      <input type="text" class="form-control" name="id_pdam" style="width: 230px;" required="required">
                    </div>
                    <div class="form-group">
                      <label for="tanggal">Alamat</label>
                      <input type="text" class="form-control" name="alamat" style="width: 230px;" required="required">
                    </div>
                    <div class="form-group">
                      <label for="tanggal">Penghuni</label>
                      <input type="text" class="form-control" name="penghuni" style="width: 230px;">
                    </div>
                    <div class="form-group">
