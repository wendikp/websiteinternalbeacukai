      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Daftar Permohonan Perbaikan Inventaris</a></li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Permohonan Perbaikan Inventaris Kategori BMN</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <tbody>
                      ...
                      while ( $i < 100) {
                        ...
                        <tr>
                          ...
                          <td></td>
                          <td>
                            <a style="padding-right: 10px" href="<?php echo base_url().'humas/artikel' ?>">View</a>
                            <a style="padding-right: 10px" href="<?php echo base_url().'humas/artikel' ?>">Edit</a>
                            <a style="padding-right: 10px" href="<?php echo base_url().'humas/artikel' ?>">Delete</a>
                            <a href="<?php echo base_url().'humas/artikel' ?>">Approve</a></td>
                          </tr>
                          <?php
                          $i++;
                        }
