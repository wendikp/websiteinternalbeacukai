      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().'proses_data/riwayatServiceRoda4'?>"> Riwayat Servis</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Tambah Riwayat Servis KBD Roda Empat : <b><?php foreach ($data as $row) {$nopol=$row->nopol; echo $row->nopol; break;} ?></b></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form action="<?php echo base_url().'proses_data/tambahRiwayatKBD4/'.$nopol?>" role="form" method="POST">
                    <div class="form-group">
                      <label for="tanggal">Tanggal</label>
                      <input type="text" class="form-control" name="tgl" placeholder="YYYY-MM-DD" style="width: 230px;" required="read_stts_cabut">
                    </div>
                    <div class="form-group">
