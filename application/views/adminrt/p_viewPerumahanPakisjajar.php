          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active"> Daftar Perumahan Pakisjajar</a></li>
              </ol>
            </section>
                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                      ...
                      <h3 class="box-title">Daftar Perumahan Pakisjajar</h3>
                      <a style="width: 110px" class="btn btn-default btn-sm pull-right" href="<?php echo base_url().'proses_data/tambahRumahPakisjajar'?>">
                        ...
                        <tbody>
                          ...
                          foreach ($data as $row) {
                            ...
                            <tr>
                              ...
                              <td><?php echo $row->id_listrik;?></td>
                              <td><?php echo $row->id_pdam;?></td>
                              <td><?php echo $row->alamat;?></td>
                              <td><?php echo $row->penghuni;?></td>
                              <td><?php echo $row->keterangan;?></td>
                              <td width="70px">
                                <div class="btn-group">
                                  <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/editInfoRumahPakisjajar/'.$row->id_rumah?>"><i class="fa fa-edit"></i>
                                  </a>
                                  <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/deleteInfoRumahPakisjajar/'.$row->id_rumah?>"><i class="fa fa-trash-o"></i>
                                  </a>
                                </div>
                              </td>
                            </tr>
