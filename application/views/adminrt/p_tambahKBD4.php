    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu menu-open" style="display: block;">
                ...
                <li class="active"><a href="../../index2.html"><i class="fa fa-car"></i> Roda Empat<i class="fa fa-angle-left pull-right"></i></a>
                  <ul class="treeview-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-suitcase"></i> <span>Barang Inventaris</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url().'proses_data/daftarPermohonanInventaris'?>"><i class="fa fa-files-o"></i> Permohonan Perbaikan <br/>Barang Inventaris Kategori BMN</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Kendaraan Bermotor Dinas (KBD) Roda Empat
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url().'adminrt'?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php echo base_url().'proses_data/get_daftarMobil'?>">  Daftar KBD Roda Empat</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Tambah KBD Roda Empat</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form name="edit" action="<?php echo base_url().'proses_data/insert_KBD4'?>" role="form" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="tanggal">Plat Nomor</label>
                      <input type="text" class="form-control" name="nopol" style="width: 230px;" required="required">
                    </div>
                    <div class="form-group">
                      <label for="tanggal">Merek</label>
                      <input type="text" class="form-control" name="merek" style="width: 230px;" required="required">
                    </div>
                    <div class="form-group">
                      <label for="tanggal">PIC</label>
                      <input type="text" class="form-control" name="pic" style="width: 230px;" required="required">
                    </div>
                    <div class="form-group">
                      <label for="tanggal">Nomor Kepemilikan</label>
                      <input type="text" class="form-control" name="nomorkep" style="width: 230px;" required="required">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputFile">Input Foto</label>
                      <input type="file" id="exampleInputFile" name="foto" required="required">
                    </div>
                    <div class="form-group">
