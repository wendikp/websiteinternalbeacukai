          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().'proses_data/daftarPermohonanCabutIzinHunian'?>"><i class="fa fa-dashboard"></i> Daftar Permohonan Cabut Izin Hunian</a></li>
                <li class="active">Permohonan Cabut Izin Hunian</li>
              </ol>
            </section>
                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Permohonan Cabut Izin Hunian</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                      <div class="col-xs-6">
                        <table class="table">
                          ...
                          foreach ($data as $row) {
                            ...
                            <thead>
                              <tr>
                                <td colspan="3" style="text-align: center;"><b>INFORMASI PERMOHONAN CABUT IZIN HUNIAN</b></td>
                              </tr>
                            </thead>
                            <tbody>
                        ...
                        <a href="<?php echo base_url().'surat_permohonan/printCabutIzinHunian/'.$row->id_permohonan?>" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Cetak</a>
                      </div>
                    </div><!-- /.box-body -->
                  </div><!-- /.box -->
                </div><!-- /.col -->
