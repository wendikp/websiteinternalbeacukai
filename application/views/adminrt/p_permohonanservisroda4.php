          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active">Daftar Permohonan Servis</li>
              </ol>
            </section>
                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Permohonan Service KBD Roda Empat</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <tbody>
                          ...
                          foreach ($data as $row) {
                            ...
                            <tr>
                              ...
                              <td width="140">
                                <div class="btn-group">
                                  <a href="<?php echo base_url().'proses_data/viewPermohonanServiceKBD4/'.$row->id_permohonan?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-eye"></i></a>
                                  <a href="<?php echo base_url().'proses_data/printPermohonanServisKBD/'.$row->id_permohonan?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-print"></i></a>
                                  <a href="<?php echo base_url().'proses_data/deletePermohonanServiceKBD4/'.$row->id_permohonan?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-trash-o"></i></a>
                                  <?php 
                                  if ($row->status == "Approved") {
                                    ?>
                                    <a href="<?php echo base_url().'proses_data/undoApprovalPermohonanServiceKBD4/'.$row->id_permohonan?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-thumbs-o-down"></i></a>
                                    <?php
                                  } else {
                                    ?>
                                    <a href="<?php echo base_url().'proses_data/approvePermohonanServiceKBD4/'.$row->id_permohonan?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-thumbs-o-up"></i></a>
                                    <?php
                                  }
                                  ?>
                                </div>
