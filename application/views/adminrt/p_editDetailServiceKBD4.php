          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().'proses_data/detailRiwayatServiceKBD4'?>"> Detail Servis</a></li>
                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                      ...
                      <h3 class="box-title">Edit Riwayat Servis KBD Roda Empat : <b><?php foreach($data as $row){ echo $row->nopol; break;}?></b></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                      <form action="<?php echo base_url().'proses_data/updateRiwayatKBD4/'.$row->id_service?>" role="form" method="POST">
                        <div class="form-group">
                          <label for="tanggal">Tanggal</label>
                          <input type="text" class="form-control" name="tgl" placeholder="YYYY-MM-DD" style="width: 230px;" value="<?php echo $row->tanggal?>">
                        </div>
                        <div class="form-group">
