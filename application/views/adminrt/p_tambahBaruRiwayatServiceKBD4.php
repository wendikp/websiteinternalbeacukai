            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Tambah Riwayat Servis KBD Roda Empat</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form action="<?php echo base_url().'proses_data/insert_tambahBaruRiwayatKBD4'?>" role="form" method="POST">
