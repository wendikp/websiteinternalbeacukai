      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Daftar Permintaan ATK</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Permintaan ATK</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <?php //echo $error;?>
                      ...
                      foreach ( $data as $row) {
                        ...
                        <tr>
                          ...
                          if ($row->read_status  == "false") {
                            ?>
                            <td><?php echo $row->nosurat?><sup><span class="label label-success">Baru</span></sup></td>
                            <?php
                          } else {
                            ?>
                          ...
                          <td width="140">
                            <div class="btn-group">
                              <a href="<?php echo base_url().'proses_data/editPermintaanATK/'.$row->kode?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo base_url().'surat_permohonan/printPermintaanATK/'.$row->kode?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-print"></i></a>
                              <a href="<?php echo base_url().'proses_data/deletePermintaanATK/'.$row->kode?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-trash-o"></i></a>
                              <?php
                              if ($row->status == "Approved") {
                                ?>
                                <a href="<?php echo base_url().'proses_data/undoApprovalPermintaanATK/'.$row->kode?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-thumbs-o-down"></i></a>
                                <?php
                              } else {
                                ?>
                                <a href="<?php echo base_url().'proses_data/approvePermintaanATK/'.$row->kode?>" class="btn btn-default btn-sm btn-size"><i class="fa fa-thumbs-o-up"></i></a>
                                <?php
                              }
                              ?>
                            </div>
