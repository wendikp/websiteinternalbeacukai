                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Riwayat Servis KBD Roda Dua</h3>&nbsp;
                      <a style="width: 110px" class="btn btn-default btn-sm pull-right" href="<?php echo base_url().'proses_data/tambahBaruRiwayatServiceKBD2'?>">
                        ...
                        <tbody>
                          ...
                          foreach ($data as $row) {
                            ...
                            <tr>
                              ...
                              <td width="80px">
                                <a style="width: 80px" class="btn btn-default btn-sm" href="<?php echo base_url().'proses_data/detailRiwayatServiceKBD2/'.$row->nopol?>"><i class="fa fa-list-ol"> Detail</i></a>
                              </td>
                            </tr>
                            <?php
                          }
