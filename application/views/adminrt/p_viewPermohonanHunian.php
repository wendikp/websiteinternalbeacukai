          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().'proses_data/daftarPermohonanRumahDinas'?>"><i class="fa fa-dashboard"></i> Daftar Permohonan Izin Hunian</a></li>
                <li class="active">Permohonan Izin Hunian</li>
              </ol>
            </section>
                      ...
                      <div class="col-xs-6">
                        <table class="table">
                          ...
                          foreach ($data as $row) {
                            ...
                            <thead>
                              <tr>
                                <td colspan="3" style="text-align: center;"><b>INFORMASI PERMOHONAN IZIN HUNIAN</b></td>
                              </tr>
                            </thead>
                            <tbody>
                        ...
                        <a href="<?php echo base_url().'surat_permohonan/printIzinHunian/'.$row->id_permohonan?>" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Cetak</a>
                      </div>
                    </div><!-- /.box-body -->
                  </div><!-- /.box -->
                </div><!-- /.col -->
