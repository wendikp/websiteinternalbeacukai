          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active"> Daftar KBD Roda Empat</a></li>
              </ol>
            </section>
                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                      ...
                      <h3 class="box-title">Info KBD Roda Empat</h3>
                      <a style="width: 110px" class="btn btn-default btn-sm pull-right" href="<?php echo base_url().'proses_data/tambahKBD4'?>">
                        <i class="fa fa-plus"> Tambah Baru</i>
                      </a>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                      <?php// echo $error;?>
                      <table id="example2" class="table table-striped table-hover" cellpadding="0">
                        <thead>
                          <tr>
                            <th>#</th>
                            <th>Plat Nomor</th>
                        ...
                        <tbody>
                          ...
                          foreach ($data as $row) {
                            ...
                            <tr>
                              ...
                              <td width="70px">
                                <div class="btn-group">
                                  <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/editInfoMobil/'.$row->nopol?>"><i class="fa fa-edit"></i>
                                  </a>
                                  <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/deleteInfoMobil/'.$row->nopol?>"><i class="fa fa-trash-o"></i>
                                  </a>
                                </div>
                              </td>
                            </tr>
