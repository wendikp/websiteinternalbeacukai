      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().'proses_data/get_daftarATK'?>">  Daftar ATK</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Tambah ATK</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form name="edit" action="<?php echo base_url().'proses_data/insertATK'?>" role="form" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="tanggal">Nama Barang</label>
                      <input type="text" class="form-control" name="atk" style="width: 230px;" required="required">
                    </div>
                    <div class="form-group">
                      <label for="tanggal">Ketersediaan</label><br/>
                      <input type="radio" name="ketersediaan" value="y" checked> Tersedia<br>
                      <input type="radio" name="ketersediaan" value="n"> Kosong<br>
                    </div>
                    <div class="form-group">
                      <label for="tanggal">Satuan</label>
                      <select class="form-control" name="satuan" style="width: 230px;" required="required">
                        <option></option>
