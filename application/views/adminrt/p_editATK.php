            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Edit ATK</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form action="<?php echo base_url().'proses_data/updateDaftarATK/'.$id_atk?>" role="form" method="POST">
                    <div class="form-group">
                      <label for="tanggal">Nama Barang</label>
                      <input type="text" class="form-control" name="atk" placeholder="YYYY-MM-DD" style="width: 230px;" value="<?php echo $atk?>">
                    </div>
                    <div class="form-group">
