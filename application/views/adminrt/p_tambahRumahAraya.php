            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Tambah Rumah Araya</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form name="edit" action="<?php echo base_url().'proses_data/insert_rumahAraya'?>" role="form" method="POST" enctype="multipart/form-data">
