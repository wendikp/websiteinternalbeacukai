          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active"> Daftar Perumahan Araya</a></li>
              </ol>
            </section>
                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                      ...
                      <h3 class="box-title">Daftar Perumahan Araya</h3>
                      <a style="width: 110px" class="btn btn-default btn-sm pull-right" href="<?php echo base_url().'proses_data/tambahRumahAraya'?>">
                        ...
                        <tbody>
                          ...
                          foreach ($data as $row) {
                            ...
                            <tr>
                              ...
                              <td width="70px">
                                <div class="btn-group">
                                  <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/editInfoRumahAraya/'.$row->id_rumah?>"><i class="fa fa-edit"></i>
                                  </a>
                                  <a class="btn btn-default btn-sm btn-size" href="<?php echo base_url().'proses_data/deleteInfoRumahAraya/'.$row->id_rumah?>"><i class="fa fa-trash-o"></i>
                                  </a>
                                </div>
                              </td>
                            </tr>
