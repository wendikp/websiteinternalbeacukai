            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Tambah Riwayat Servis KBD Roda Dua : <b><?php foreach ($data as $row) {$nopol=$row->nopol; echo $row->nopol; break;} ?></b></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form action="<?php echo base_url().'proses_data/tambahRiwayatKBD2/'.$nopol?>" role="form" method="POST">
