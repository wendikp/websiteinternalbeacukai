            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Edit Info KBD Roda Dua : 
                    <b>
                      <?php
                      foreach ($data as $row) {
                        echo $row->nopol;
                  ...
                  <div class="box-body">
                    ...
                    foreach($data as $row){
                      ?>
                      <form name="edit" action="<?php echo base_url().'proses_data/updateInfoMotor/'.$row->nopol?>" role="form" method="POST" enctype="multipart/form-data">
