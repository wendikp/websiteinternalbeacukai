      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().'proses_data/get_daftarMotor'?>">  Daftar KBD Roda Dua</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Tambah KBD Roda Dua</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form name="edit" action="<?php echo base_url().'proses_data/insert_KBD2'?>" role="form" method="POST" enctype="multipart/form-data">
